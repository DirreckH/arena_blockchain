...
describe('submissions page', () => {
  ...
  it('opens a requester export artifact from the submissions flow', async () => {
    ...
    expect(screen.getByTestId('requester-export-detail-open-count')).toHaveTextContent('4')
    ...
    expect(screen.getByTestId('requester-export-detail-created-count')).toHaveTextContent('5')
    expect(screen.getByTestId('requester-export-detail-market-enabled-count')).toHaveTextContent('5')
