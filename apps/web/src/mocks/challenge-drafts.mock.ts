...
const DEFAULT_DRAFTS: ChallengeDraft[] = [
  ...
  {
    id: 'draft-dao-treasury',
    title: 'DAO 观察者是否会普遍认为，该 DAO 本季度的国库配置更偏向稳健防守而非风险扩张？',
    summary: '围绕 DAO 国库披露、资产结构变化和治理讨论，评估参与者是否会普遍认为该 DAO 本季度的国库配置更偏向稳健防守而非风险扩张。',
    optionA: '会被视为更偏向稳健防守',
    optionB: '不会被视为更偏向稳健防守',
    category: 'DAO',
    tags: ['experienced_user', 'interested_in_dao'],
    referenceLink: 'https://dao.example.com/treasury',
    completion: 86,
    status: 'draft',
    updatedAt: '9 分钟前',
  },
